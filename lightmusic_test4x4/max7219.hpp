...
public:
     ...
     */
    void setPixel(int x, int y, int matrix[LEDMATRIX_SIZE_X+1][LEDMATRIX_SIZE_Y+1], int data);
     ...
     */
    void Setup(int matrix[LEDMATRIX_SIZE_X+1][LEDMATRIX_SIZE_Y+1]);
     ...
     */
    void set8x8matrix(const int inputmatrix[LEDMATRIX_SIZE_X+1][LEDMATRIX_SIZE_X+1], int outputmatrix[LEDMATRIX_SIZE_X+1][LEDMATRIX_SIZE_Y+1], int ledX);
    
    /**
     * @brief Virtual to clear the full matrix(now: (8,32))
     * @param matrix    ~ The matrix that will be cleared
     */
    void clear(int matrix[LEDMATRIX_SIZE_X+1][LEDMATRIX_SIZE_Y+1]);
    
    /**
     * @brief draws the matrix to the ledmatrix
     * @param matrix    ~ Matrix that will be written to led matrix
     */
    void draw(int matrix[LEDMATRIX_SIZE_X+1][LEDMATRIX_SIZE_Y+1]);
